...
(function () {
  ...
  if (!EMBED) {
    ...
    style.textContent = [
      ...
      'background:linear-gradient(160deg,rgba(16,20,36,0.82),rgba(10,13,24,0.86));',
      '-webkit-backdrop-filter:blur(24px) saturate(1.6);backdrop-filter:blur(24px) saturate(1.6);',
      'border:1px solid rgba(255,255,255,0.12);border-radius:999px;',
      'font-family:"Inter","Noto Sans SC","PingFang SC",sans-serif;font-size:13px;color:#e7eaf3;',
      'box-shadow:0 12px 40px rgba(0,0,0,0.5),0 0 0 1px rgba(129,140,248,0.1),inset 0 1px 0 rgba(255,255,255,0.09);}',
      ...
      '#mei-topbar .mei-brand{display:flex;align-items:center;gap:8px;font-weight:700;font-size:13.5px;margin-right:6px;flex-shrink:0;color:#e7eaf3;}',
      ...
      'cursor:pointer;border:1px solid transparent;background:transparent;color:#9aa3b8;',
      'font-size:12.5px;white-space:nowrap;transition:all .18s ease;text-decoration:none;}',
      '#mei-topbar .mei-btn:hover{background:rgba(255,255,255,0.08);color:#e7eaf3;}',
      ...
      'background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);color:#c3c9d9;font-size:12.5px;',
      'flex-shrink:0;cursor:pointer;text-decoration:none;transition:all .18s;}',
      '#mei-topbar .mei-user:hover{background:rgba(255,255,255,0.12);color:#fff;}',
      ...
      'border-radius:999px;border:1px solid rgba(255,255,255,0.12);background:transparent;cursor:pointer;font-size:14px;',
      'color:#9aa3b8;transition:all .18s;}',
      '#mei-topbar .mei-gear:hover,#mei-topbar .mei-gear.open{background:rgba(255,255,255,0.1);color:#fff;}',
      '#mei-topbar .mei-menu{position:absolute;right:-8px;top:44px;width:260px;padding:8px;z-index:10001;',
      'background:rgba(13,17,30,0.92);-webkit-backdrop-filter:blur(28px) saturate(1.6);backdrop-filter:blur(28px) saturate(1.6);',
      'border:1px solid rgba(255,255,255,0.14);border-radius:18px;',
      'box-shadow:0 20px 60px rgba(0,0,0,0.6),0 0 0 1px rgba(129,140,248,0.12);}',
      '#mei-topbar .mei-menu-title{padding:7px 10px 5px;font-size:10.5px;color:#5f6880;font-weight:700;letter-spacing:1.5px;}',
      '#mei-topbar .mei-switch{display:flex;align-items:center;gap:8px;width:100%;padding:7px 10px;border:none;',
      'background:transparent;cursor:pointer;border-radius:10px;color:#e7eaf3;font-size:13px;text-align:left;}',
      '#mei-topbar .mei-switch:hover{background:rgba(255,255,255,0.07);}',
      '#mei-topbar .mei-switch .mei-switch-label{flex:1;opacity:.92;}',
      '#mei-topbar .mei-switch.off .mei-switch-label{opacity:.4;}',
      '#mei-topbar .mei-track{width:34px;height:19px;border-radius:999px;background:rgba(255,255,255,0.14);position:relative;flex-shrink:0;transition:all .18s;}',
      ...
      '#mei-topbar .mei-menu-sep{height:1px;background:rgba(255,255,255,0.09);margin:5px 4px;}',
      '#mei-topbar .mei-menu-link{display:flex;align-items:center;gap:8px;width:100%;padding:7px 10px;border:none;',
      'background:transparent;cursor:pointer;border-radius:10px;color:#e7eaf3;font-size:13px;text-align:left;text-decoration:none;}',
      '#mei-topbar .mei-menu-link:hover{background:rgba(255,255,255,0.07);}',

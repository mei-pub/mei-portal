...
const ICONS: Record<string, (p: P) => JSX.Element> = {
  ...
  'lucide:circle-play': (p) => (
    <S {...p}><circle cx="12" cy="12" r="10" /><polygon points="10 8 16 12 10 16 10 8" fill="currentColor" stroke="none" /></S>
  ),
  ...
  // ===== 播放条（MusicDock）用控件图标：path 数据取自 lucide 官方，离线可用 =====
  'lucide:pause': (p) => (
    <S {...p}><rect x="14" y="4" width="4" height="16" rx="1" /><rect x="6" y="4" width="4" height="16" rx="1" /></S>
  ),
  'lucide:skip-back': (p) => (
    <S {...p}><polygon points="19 20 9 12 19 4 19 20" /><line x1="5" y1="19" x2="5" y2="5" /></S>
  ),
  'lucide:skip-forward': (p) => (
    <S {...p}><polygon points="5 4 15 12 5 20 5 4" /><line x1="19" y1="5" x2="19" y2="19" /></S>
  ),
  'lucide:shuffle': (p) => (
    <S {...p}>
  ...
  'lucide:list': (p) => (
    <S {...p}>
      <line x1="3" y1="6" x2="3.01" y2="6" /><line x1="8" y1="6" x2="21" y2="6" />
      <line x1="3" y1="12" x2="3.01" y2="12" /><line x1="8" y1="12" x2="21" y2="12" />
      <line x1="3" y1="18" x2="3.01" y2="18" /><line x1="8" y1="18" x2="21" y2="18" />
    </S>
  ),
  'lucide:loader': (p) => (
    <S {...p}>
  ...
  'lucide:volume-1': (p) => (
    <S {...p}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" /><path d="M15.54 8.46a5 5 0 0 1 0 7.07" /></S>
  ),
  'lucide:volume-2': (p) => (
    <S {...p}>
  ...
  'lucide:chevron-up': (p) => (
    <S {...p}><path d="m18 15-6-6-6 6" /></S>
  ),
  'lucide:chevron-down': (p) => (

  ...
  return (
    <>
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-6">
        {/* Back button */}
        <Link href="/" className="inline-flex items-center gap-1 text-sm text-[var(--muted)] hover:text-[var(--foreground)] mb-4 transition-colors">
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="flex gap-3">
              {novel.chapters && novel.chapters.length > 0 ? (
                <>
                  <Link
                    href={`/novels/${novelId}/read`}
                    className="inline-flex items-center gap-1.5 px-3 sm:px-5 py-2 bg-[var(--primary)] text-white text-sm font-medium rounded-lg hover:bg-[var(--primary-hover)] transition-colors"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <Link
                    href={`/novels/${novelId}/read?fulltext=parallel`}
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <Link
                        href={`/novels/${novelId}/read?chapter=${ch.id}`}
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity ml-2">
                      <Link
                        href={`/novels/${novelId}/chapters/${ch.id}/edit`}
                        className="p-1.5 text-[var(--muted)] hover:text-[var(--primary)] rounded-md transition-colors"
                        title="编辑章节"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="bg-white rounded-xl w-full max-w-sm mx-4 p-5" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex justify-end gap-2 mt-5">
              ...
              <button
                ...
                disabled={creating}
                className="px-4 py-2 text-sm bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary-hover)] transition-colors disabled:opacity-50"
              >
